...
const{newApplet} = await import ("$:/plugins/bj/tiddlywiki-preact/dev/module/newApplet.mjs")

const{newTiddler} = await import ("$:/plugins/bj/tiddlywiki-preact/utils.mjs")
...
const source="[[$:/plugins/bj/tiddlywiki-preact/dev/blankstart.mjs]]"
